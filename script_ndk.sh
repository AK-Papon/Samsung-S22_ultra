...
make O=out ARCH=arm64 bklyn_defconfig

# make O=out ARCH=arm64 tpp-perf_defconfig

PATH="${HOME}/Kernel_Development/ndk/android-ndk-r26b-linux/android-ndk-r26b/toolchains/llvm/prebuilt/linux-x86_64/bin:${HOME}/Kernel_Development/ndk/gcc-linaro-aarch64-linux-gnu/bin:${HOME}/Kernel_Development/ndk/gcc-linaro-aarch64_arm-linux-gnueabihf/bin:${PATH}" 
